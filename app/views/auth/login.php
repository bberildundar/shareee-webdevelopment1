            ...
            <div class="bg-white p-6  shadow-lg rounded-lg">
                ...
                <form method="post" action="/auth/login">
                    <div class="mb-4">
                        ...
                        <input type="text" id="username" name="username" placeholder="username" class="w-full p-2 px-4 border border-gray-300 rounded-full" required>
                    </div>
                    <div class="mb-2">
                        <label for="password" class="pl-4 mb-1 block text-gray-800 font-semibold">Password</label>
                        <input type="password" id="password" name="password" placeholder="*************" class="w-full p-2 px-4 border border-gray-300 rounded-full" required>
                    </div>
                    <?php if (isset($errorMessage)) : ?>
                        <p class="text-red-400"><?= $errorMessage ?></p>
                    <?php endif; ?>
                    <button type="submit" class="ml-4 mt-2 bg-indigo-900 text-white hover:bg-indigo-950 px-6 py-2 ">Login</button>
                </form>
